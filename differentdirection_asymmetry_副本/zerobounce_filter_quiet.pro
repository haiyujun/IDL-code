...
restore,'/Users/lihaiyu/Desktop/IDL code/c_corr/ccr_asymmetry/differentdirection_asymmetry/result/quiet_ref/ccrquiet_halfmeantotal.sav'
;tt[1]=19*45/60.0
y=60.0/45*interpol(tt,1440*2+1);原始tt的单位是分钟，现在转化为帧（45s）
;=interpol(dd,1450*2)
ccr01=fltarr(151,301)
tmp0=fltarr(151,151)
tmp=fltarr(151,301)
