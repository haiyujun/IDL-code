...
y[0,0]=58.945545*1d6;x0(m)
y[0,1]=-0.72576602*1d6;z0(m)
y[0,2]=6.0750332*1d-7;p0(m^-1)
y[0,3]=5.16*1d-11;q0
...
print,'dx=',abs(y[0,0]/1000000.0-x_upMm[0])
print,'dt=',(s[i_upMm[0]])/omg
print,abs(x_upMm[1]-x_upMm[0])
print,(s[i_upMm[1]]-s[i_upMm[0]])/omg
print,'mean_disp=',mean(disp[0:i_upMm[0]])
toc
;print,mean(disp[i_upMm[0]:i_upMm[1]])
