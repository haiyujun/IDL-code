...
y[0,0]=-10.036190*1d6;x0(m)
y[0,1]=-0.12809380*1d6;z0(m)
y[0,2]=8.42*1d-7;p0(m^-1)
y[0,3]=1.69*1d-8;q0
...
;    if (k1[i,1] GT 0) AND (k111 LT 0) then begin
;        l=50000/(sqrt(k1[i,0]^2+k1[i,1]^2)) 
;        print,'gonnalong'
;    endif else begin
...
print,y[0,0]/1000000.0-x_upMm[0]
print,(s[i_upMm[0]])/omg
print,x_upMm[0]-x_upMm[1]
print,(s[i_upMm[1]]-s[i_upMm[0]])/omg
